...
print("本次速度7的数字是:" + str(luck_umber))

class StatusBar():
    def score_label(self):
        self.score = 0
        pos_x = SCREEN_WIDTH -1200
        pos_y = SCREEN_HEIGHT -25
        draw_text(f"得分:",pos_x,pos_y,color.BLUE,20,font_name=("simhei","coure"))
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.fishes = {"resource/黄鱼.png": 1, "resource/绿鱼.png": 3,
                       "resource/红鱼.png": 5, "resource/紫鱼.png": 7, "resource/蓝鱼.png": 9}
        self.fishes_list = ["resource/黄鱼.png",
                            "resource/绿鱼.png",
                            "resource/红鱼.png",
                            "resource/紫鱼.png",
                            "resource/蓝鱼.png"]
    ...
    def on_update(self, delta_time):     
        ...
        for enemy in self.enemy_sprite_list:
            if enemy.center_x < -60 or enemy.center_x  > SCREEN_WIDTH + 60:
                enemy.kill()
        fh_list = check_for_collision_with_list(
